...
def wordcloud_generate(image_name, wdcloud):
    ...
    cmap = mpl.cm.Purples(np.linspace(0,1,20)) #['Greys', 'Purples', 'Blues', 'Greens', 'Oranges', 'Reds','YlOrBr', 'YlOrRd',
                                                #'OrRd', 'PuRd', 'RdPu', 'BuPu','GnBu', 'PuBu', 'YlGnBu', 'PuBuGn', 'BuGn', 'YlGn']
    cmap = mpl.colors.ListedColormap(cmap[-10:,:-1]) 

    #create and generate our wordcloud object
    wordcloud = WordCloud(background_color='black',contour_color='black',max_words=500,mask=cand_mask,
...
file_contents = file_extract('Endgame.txt')
wdcloud = dic_generation(file_contents)
wordcloud_generate('Avengers.jpg', wdcloud)
