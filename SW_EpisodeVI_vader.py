...
def wordcloud_generate(image_name, wdcloud):
    ...
    cmap = mpl.cm.Reds(np.linspace(0,1,20)) #['Greys', 'Purples', 'Blues', 'Greens', 'Oranges', 'Reds','YlOrBr', 'YlOrRd',
...
file_contents = file_extract('SW_EpisodeVI.txt')
wdcloud = dic_generation(file_contents)
wordcloud_generate('vader.jpg', wdcloud)
